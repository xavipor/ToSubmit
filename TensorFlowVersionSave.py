...
#    pdb.set_trace()
    ...
    Z3a =tf.nn.conv3d(A2,W_L2,strides=[1,1,1,1,1],padding='VALID') 
    Z3b = tf.nn.bias_add(Z3a,b_L2)
    A3 = tf.nn.relu(Z3b)
...
def train(learning_rate=0.001,num_epochs =5000,beta=0):
    myPathModel = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/code/lib/SavedModel/31082018_Z14_MyPreprocess_AlLayers_MoreImages_NoReg/'
    if not os.path.exists(myPathModel):
	os.makedirs(myPathModel)

#    myBatchGenerator = Bachitazion(sizeOfBatch = 4096, pathT = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/data/Z14MyPreProcessGood/')
    myBatchGenerator = Bachitazion(sizeOfBatch = 4096, pathT = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/data/MoreImagesTheirSizesNewPreProcess/')
#    myBatchGenerator = Bachitazion(sizeOfBatch = 4096, pathT = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/data/Z14MyPreProcess/')
#    myBatchGenerator = Bachitazion(sizeOfBatch = 4096, pathT = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/data/Z14NewDistributionMoreImages/')
#    myBatchGenerator = Bachitazion(sizeOfBatch = 2048, pathT = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/data/Z14NewDistribution/')
...
#    myBatchGenerator = Bachitazion(sizeOfBatch = 4096, pathT = '/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/demo/data/Z14MoreSamples/')
#    myBatchGenerator = Bachitazion(sizeOfBatch=2048,pathT='/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/data/TheirSizes/AllPatchesWithMicrobleedsTrain/')
#    myBatchGenerator = Bachitazion(sizeOfBatch=100,pathT='/home/jdominguezmartinez/pruebas/Microbleeds/cmb-3dcnn-code-v1.0/data/AugmentedImages/')
